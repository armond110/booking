...
export default function Header() {
  ...
  return (
    <>
    <div className="shadow-md w-full fixed md:sticky bottom-0  md:px-10 lg:px-20 2xl:px-48">
      <div className="flex items-center justify-between bg-white py-4 ">
        ...
        {!!user && (
        <div className="flex md:absolute md:right-0 md:px-10 lg:px-20 2xl:px-48 justify-center  items-center mx-auto gap-2">
        ...
        {!user && (
        <div className="flex md:absolute md:right-0 md:px-24 justify-center  items-center mx-auto gap-2">
        <Link to={'/'} className="md:hidden inline-flex w-full justify-center gap-x-1.5 rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
         <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
        </svg>
