...
export default function PlacesPage() {
  ...
  return (
    <div className="mt-8 mb-24 md:mt-0">
      <AccountNav />
        <div className="text-center">
        <h1 className="md:hidden   bg-white  border-black text-black   text-xl gap-2 mb-8  py-2 uppercase text-center">My Accomodations</h1>
