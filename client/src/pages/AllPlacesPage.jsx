    ...
    <div className="gap-6 gap-y-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 4xl:grid-cols-5   px-4 md:px-20 text-left   py-20 md:py-6  "> 
      ...
      {places.length > 0 && places.map((place, index) => (
        <div>
            ...
            <button onclick={submit()} className="bg-white relative ">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="absolute top-4 left-3 size-7  rounded-lg    font-semibold  text-yellow-300 bg-gray-900 opacity-70">
