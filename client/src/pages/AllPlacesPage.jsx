...
export default function AllPlacesPage({places}) {
  ...
  return (
    <div className="gap-6 gap-y-8 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 px-8 md:px-12 lg:px-24 2xl:px-72  py-20 md:py-6 text-center justify-center"> 
