  ...
  return (
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-16  text-center text-2xl/9 font-bold tracking-tight text-gray-900">
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className=" mt-10 text-center text-sm/6 text-gray-500 mb-56">
        Don't have an account yet?{' '}
          <Link  className="font-semibold text-blue-700 hover:text-indigo-500 underline" to={'/register'}>
          Register here
          </Link>
        </p>
      </div>
